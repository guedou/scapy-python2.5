...
RUN apt-get update && apt-get install -y software-properties-common && add-apt-repository -y ppa:fkrull/deadsnakes && \
...
#RUN git clone https://github.com/secdev/scapy --depth 1 && \
#    python --version && \
